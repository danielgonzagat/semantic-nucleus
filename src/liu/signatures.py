...
def _bootstrap() -> None:
    ...
    _rel("code/MODULE", Sort.CODE, Sort.STRUCTURE)
    _rel("code/DEFN", Sort.CODE, Sort.STRUCTURE)
    _rel("code/CLAUSE", Sort.CODE, Sort.STRUCTURE)
    _rel("code/PARAM", Sort.CODE, Sort.STRUCTURE)
    _rel("code/RETURNS", Sort.CODE, Sort.TYPE)
    _rel("code/CALL", Sort.CODE, Sort.CODE, Sort.STRUCTURE)
    _rel("code/ASSIGN", Sort.STRUCTURE, Sort.STRUCTURE)
    _rel("code/IF", Sort.STRUCTURE, Sort.STRUCTURE, Sort.STRUCTURE)
    _rel("code/LOOP", Sort.STRUCTURE, Sort.STRUCTURE, Sort.STRUCTURE)
    _rel("code/MATCH", Sort.STRUCTURE, Sort.STRUCTURE)
    _rel("code/BORROW", Sort.CODE, Sort.TEXT, Sort.TEXT)
    _rel("code/MOVE", Sort.CODE)
    _rel("code/TYPE", Sort.CODE, Sort.TYPE)
    _rel("code/ANNOTATION", Sort.CODE, Sort.CONTEXT)
