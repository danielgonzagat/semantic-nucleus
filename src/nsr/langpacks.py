...
# Expand verbs with autogenerated datasets
LANGUAGE_PACK_DATA["pt"]["lexemes"].extend(PT_VERB_LEXEMES)
LANGUAGE_PACK_DATA["pt"].setdefault("conjugations", []).extend(PT_CONJUGATIONS)
LANGUAGE_PACK_DATA["es"]["lexemes"].extend(ES_VERB_LEXEMES)
LANGUAGE_PACK_DATA["es"].setdefault("conjugations", []).extend(ES_CONJUGATIONS)
LANGUAGE_PACK_DATA["fr"]["lexemes"].extend(FR_VERB_LEXEMES)
LANGUAGE_PACK_DATA["fr"].setdefault("conjugations", []).extend(FR_CONJUGATIONS)
LANGUAGE_PACK_DATA.setdefault("it", {}).setdefault("lexemes", []).extend(IT_VERB_LEXEMES)
...
LANGUAGE_PACK_DATA["en"]["lexemes"].extend(EN_VERB_LEXEMES)
