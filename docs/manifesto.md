...
- Detecção de contradições ativa por padrão e configurável (`Config.enable_contradiction_check`, `nsr.consistency.detect_contradictions`, flag CLI `--disable-contradictions`).
