...
- Probabilidades contextuais determinísticas (`context_probabilities`) acompanham cada meta_summary: contagens normalizadas de relações, tags de contexto e goals são calculadas a partir do ISR, permitindo priorização simbólica sem pesos ocultos.
