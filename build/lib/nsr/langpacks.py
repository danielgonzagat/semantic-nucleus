    ...
    "pt": {
        "lexemes": [
            ...
            {"lemma": "TRISTE", "semantics": "STATE_BAD", "pos": "ADJ", "forms": ["TRISTE"]},
              {"lemma": "OBRIGADO", "semantics": "THANKS", "pos": "INTERJ", "forms": ["OBRIGADO", "OBRIGADA", "VALEU"]},
              {"lemma": "TCHAU", "semantics": "FAREWELL", "pos": "INTERJ", "forms": ["TCHAU", "TCHAO", "ADEUS"]},
              {"lemma": "FAÇA", "semantics": "COMMAND", "pos": "VERB", "forms": ["FAÇA", "FACA", "EXECUTE", "CALCULE", "RESOLVA"]},
              {"lemma": "CERTO", "semantics": "CONFIRM", "pos": "ADV", "forms": ["CERTO", "OK", "TÁ", "TA"]},
              {"lemma": "QUE", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["QUE"]},
              {"lemma": "QUAL", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["QUAL"]},
        ],
        ...
        "syntactic_patterns": [
            ...
            {"name": "ANSWER_HEALTH", "sequence": ["STATE_GOOD", "CONJ_AND", "YOU"]},
              {"name": "THANKS_PT", "sequence": ["THANKS"]},
              {"name": "COMMAND_PT", "sequence": ["COMMAND"]},
              {"name": "FAREWELL_PT", "sequence": ["FAREWELL"]},
              {"name": "CONFIRM_PT", "sequence": ["CONFIRM"]},
              {"name": "QUESTION_FACT_PT", "sequence": ["QUESTION_FACT"]},
        ],
        "idiom_equivalents": [
        ...
        "dialog_rules": [
            ...
            },
            {
              ...
              {
                  "trigger_role": "THANKS_PT",
                  "reply_role": "THANKS_PT_REPLY",
                  "reply_semantics": "THANKS_ACK",
                  "surface_tokens": ["de", "nada", "!"],
                  "language": "pt",
              },
              {
                  "trigger_role": "COMMAND_PT",
                  "reply_role": "COMMAND_PT_ACK",
                  "reply_semantics": "COMMAND_ACK",
                  "surface_tokens": ["certo", ",", "encaminhando", "para", "o", "núcleo", "."],
                  "language": "pt",
              },
              {
                  "trigger_role": "QUESTION_FACT_PT",
                  "reply_role": "FACT_ROUTE_PT",
                  "reply_semantics": "FACT_ROUTE",
                  "surface_tokens": ["vou", "consultar", "o", "NSR", "."],
                  "language": "pt",
              },
              {
                  "trigger_role": "FAREWELL_PT",
                  "reply_role": "FAREWELL_PT_REPLY",
                  "reply_semantics": "FAREWELL_ACK",
                  "surface_tokens": ["até", "logo", "."],
                  "language": "pt",
              },
              {
                  "trigger_role": "CONFIRM_PT",
                  "reply_role": "CONFIRM_PT_REPLY",
                  "reply_semantics": "CONFIRM_ACK",
                  "surface_tokens": ["ok", ",", "seguindo", "."],
                  "language": "pt",
              },
        ],
        "conjugations": [
            ...
            {"lemma": "estar", "tense": "pres", "person": 3, "number": "plur", "form": "estão"},
              {"lemma": "ter", "tense": "pres", "person": 1, "number": "sing", "form": "tenho"},
              {"lemma": "ter", "tense": "pres", "person": 2, "number": "sing", "form": "tem"},
              {"lemma": "ter", "tense": "pres", "person": 3, "number": "sing", "form": "tem"},
              {"lemma": "ter", "tense": "pres", "person": 1, "number": "plur", "form": "temos"},
              {"lemma": "ter", "tense": "pres", "person": 2, "number": "plur", "form": "têm"},
              {"lemma": "ter", "tense": "pres", "person": 3, "number": "plur", "form": "têm"},
              {"lemma": "ficar", "tense": "pres", "person": 1, "number": "sing", "form": "fico"},
              {"lemma": "ficar", "tense": "pres", "person": 2, "number": "sing", "form": "fica"},
              {"lemma": "ficar", "tense": "pres", "person": 3, "number": "sing", "form": "fica"},
        ],
    },
    "en": {
        "lexemes": [
            ...
            {"lemma": "BE", "semantics": "BE_STATE", "pos": "VERB", "forms": ["ARE", "AM", "IS"]},
              {"lemma": "THANKS", "semantics": "THANKS", "pos": "INTERJ", "forms": ["THANKS"]},
              {"lemma": "BYE", "semantics": "FAREWELL", "pos": "INTERJ", "forms": ["BYE", "GOODBYE", "SEEYA"]},
              {"lemma": "OK", "semantics": "CONFIRM", "pos": "ADV", "forms": ["OK", "OKAY", "SURE"]},
              {"lemma": "WHAT", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["WHAT"]},
              {"lemma": "DO", "semantics": "COMMAND", "pos": "VERB", "forms": ["DO", "PLEASE", "CALCULATE", "COMPUTE"]},
        ],
        ...
        "syntactic_patterns": [
            ...
            {"name": "QUESTION_HEALTH_VERBOSE_EN", "sequence": ["QUESTION_HOW", "SELF", "STATE_GOOD"]},
              {"name": "THANKS_EN", "sequence": ["THANKS"]},
              {"name": "FAREWELL_EN", "sequence": ["FAREWELL"]},
              {"name": "CONFIRM_EN", "sequence": ["CONFIRM"]},
              {"name": "QUESTION_FACT_EN", "sequence": ["QUESTION_FACT"]},
              {"name": "COMMAND_EN", "sequence": ["COMMAND"]},
        ],
        "idiom_equivalents": [
        ...
        "dialog_rules": [
            ...
            },
            {
              ...
              {
                  "trigger_role": "THANKS_EN",
                  "reply_role": "THANKS_EN_REPLY",
                  "reply_semantics": "THANKS_ACK",
                  "surface_tokens": ["you're", "welcome", "!"],
                  "language": "en",
              },
              {
                  "trigger_role": "FAREWELL_EN",
                  "reply_role": "FAREWELL_EN_REPLY",
                  "reply_semantics": "FAREWELL_ACK",
                  "surface_tokens": ["bye", "!"],
                  "language": "en",
              },
              {
                  "trigger_role": "CONFIRM_EN",
                  "reply_role": "CONFIRM_EN_REPLY",
                  "reply_semantics": "CONFIRM_ACK",
                  "surface_tokens": ["ok", ",", "doing", "that", "."],
                  "language": "en",
              },
              {
                  "trigger_role": "QUESTION_FACT_EN",
                  "reply_role": "FACT_ROUTE_EN",
                  "reply_semantics": "FACT_ROUTE",
                  "surface_tokens": ["let", "me", "check", "that", "."],
                  "language": "en",
              },
              {
                  "trigger_role": "COMMAND_EN",
                  "reply_role": "COMMAND_EN_ACK",
                  "reply_semantics": "COMMAND_ACK",
                  "surface_tokens": ["acknowledged", ",", "dispatching", "to", "NSR", "."],
                  "language": "en",
              },
        ],
        "conjugations": [
            ...
            {"lemma": "be", "tense": "pres", "person": 3, "number": "sing", "form": "is"},
              {"lemma": "have", "tense": "pres", "person": 1, "number": "sing", "form": "have"},
              {"lemma": "have", "tense": "pres", "person": 3, "number": "sing", "form": "has"},
        ],
    },
    "es": {
        "lexemes": [
            ...
            {"lemma": "ESTAR", "semantics": "BE_STATE", "pos": "VERB", "forms": ["ESTOY", "ESTÁS", "ESTA"]},
              {"lemma": "GRACIAS", "semantics": "THANKS", "pos": "INTERJ", "forms": ["GRACIAS"]},
              {"lemma": "ADIOS", "semantics": "FAREWELL", "pos": "INTERJ", "forms": ["ADIOS", "ADIÓS", "CHAU"]},
              {"lemma": "VALE", "semantics": "CONFIRM", "pos": "ADV", "forms": ["VALE", "OK"]},
              {"lemma": "QUE", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["QUE", "QUÉ"]},
              {"lemma": "HAZ", "semantics": "COMMAND", "pos": "VERB", "forms": ["HAZ", "CALCULA", "EJECUTA"]},
        ],
        ...
        "syntactic_patterns": [
            ...
            {"name": "QUESTION_HEALTH_VERBOSE_ES", "sequence": ["SELF", "STATE_GOOD", "CONJ_AND", "YOU"]},
              {"name": "THANKS_ES", "sequence": ["THANKS"]},
              {"name": "FAREWELL_ES", "sequence": ["FAREWELL"]},
              {"name": "CONFIRM_ES", "sequence": ["CONFIRM"]},
              {"name": "QUESTION_FACT_ES", "sequence": ["QUESTION_FACT"]},
              {"name": "COMMAND_ES", "sequence": ["COMMAND"]},
        ],
        "idiom_equivalents": [
        ...
        "dialog_rules": [
            ...
            },
            {
              ...
              {
                  "trigger_role": "THANKS_ES",
                  "reply_role": "THANKS_ES_REPLY",
                  "reply_semantics": "THANKS_ACK",
                  "surface_tokens": ["de", "nada", "!"],
                  "language": "es",
              },
              {
                  "trigger_role": "FAREWELL_ES",
                  "reply_role": "FAREWELL_ES_REPLY",
                  "reply_semantics": "FAREWELL_ACK",
                  "surface_tokens": ["hasta", "luego", "."],
                  "language": "es",
              },
              {
                  "trigger_role": "CONFIRM_ES",
                  "reply_role": "CONFIRM_ES_REPLY",
                  "reply_semantics": "CONFIRM_ACK",
                  "surface_tokens": ["vale", ",", "lo", "hago", "."],
                  "language": "es",
              },
              {
                  "trigger_role": "QUESTION_FACT_ES",
                  "reply_role": "FACT_ROUTE_ES",
                  "reply_semantics": "FACT_ROUTE",
                  "surface_tokens": ["consultaré", "el", "núcleo", "."],
                  "language": "es",
              },
              {
                  "trigger_role": "COMMAND_ES",
                  "reply_role": "COMMAND_ES_ACK",
                  "reply_semantics": "COMMAND_ACK",
                  "surface_tokens": ["entendido", ",", "ejecutando", "."],
                  "language": "es",
              },
        ],
        "conjugations": [
            ...
            {"lemma": "estar", "tense": "pres", "person": 3, "number": "sing", "form": "está"},
              {"lemma": "tener", "tense": "pres", "person": 1, "number": "sing", "form": "tengo"},
              {"lemma": "tener", "tense": "pres", "person": 3, "number": "sing", "form": "tiene"},
        ],
    },
    "fr": {
        "lexemes": [
            ...
            {"lemma": "ALLER", "semantics": "BE_STATE", "pos": "VERB", "forms": ["VA", "VAS", "VAIS"]},
              {"lemma": "MERCI", "semantics": "THANKS", "pos": "INTERJ", "forms": ["MERCI"]},
              {"lemma": "ADIEU", "semantics": "FAREWELL", "pos": "INTERJ", "forms": ["ADIEU"]},
              {"lemma": "DACCORD", "semantics": "CONFIRM", "pos": "ADV", "forms": ["D'ACCORD", "DACCORD", "OK"]},
              {"lemma": "QUOI", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["QUOI", "QUE"]},
              {"lemma": "FAIS", "semantics": "COMMAND", "pos": "VERB", "forms": ["FAIS", "CALCULE", "EXECUTE"]},
        ],
        ...
        "syntactic_patterns": [
            ...
            {"name": "QUESTION_HEALTH_VERBOSE_FR", "sequence": ["SELF", "BE_STATE", "STATE_GOOD", "CONJ_AND", "YOU"]},
              {"name": "THANKS_FR", "sequence": ["THANKS"]},
              {"name": "FAREWELL_FR", "sequence": ["FAREWELL"]},
              {"name": "CONFIRM_FR", "sequence": ["CONFIRM"]},
              {"name": "QUESTION_FACT_FR", "sequence": ["QUESTION_FACT"]},
              {"name": "COMMAND_FR", "sequence": ["COMMAND"]},
        ],
        "idiom_equivalents": [
        ...
        "dialog_rules": [
            ...
            },
            {
              ...
              {
                  "trigger_role": "THANKS_FR",
                  "reply_role": "THANKS_FR_REPLY",
                  "reply_semantics": "THANKS_ACK",
                  "surface_tokens": ["de", "rien", "!"],
                  "language": "fr",
              },
              {
                  "trigger_role": "FAREWELL_FR",
                  "reply_role": "FAREWELL_FR_REPLY",
                  "reply_semantics": "FAREWELL_ACK",
                  "surface_tokens": ["à", "bientôt", "."],
                  "language": "fr",
              },
              {
                  "trigger_role": "CONFIRM_FR",
                  "reply_role": "CONFIRM_FR_REPLY",
                  "reply_semantics": "CONFIRM_ACK",
                  "surface_tokens": ["d'accord", ",", "je", "continue", "."],
                  "language": "fr",
              },
              {
                  "trigger_role": "QUESTION_FACT_FR",
                  "reply_role": "FACT_ROUTE_FR",
                  "reply_semantics": "FACT_ROUTE",
                  "surface_tokens": ["je", "consulte", "le", "NSR", "."],
                  "language": "fr",
              },
              {
                  "trigger_role": "COMMAND_FR",
                  "reply_role": "COMMAND_FR_ACK",
                  "reply_semantics": "COMMAND_ACK",
                  "surface_tokens": ["d'accord", ",", "mise", "en", "file", "."],
                  "language": "fr",
              },
        ],
        "conjugations": [
            ...
            {"lemma": "aller", "tense": "pres", "person": 3, "number": "sing", "form": "va"},
              {"lemma": "etre", "tense": "pres", "person": 1, "number": "sing", "form": "suis"},
              {"lemma": "etre", "tense": "pres", "person": 3, "number": "sing", "form": "est"},
              {"lemma": "avoir", "tense": "pres", "person": 1, "number": "sing", "form": "ai"},
              {"lemma": "avoir", "tense": "pres", "person": 3, "number": "sing", "form": "a"},
        ],
      },
      "it": {
          "lexemes": [
              ...
              {"lemma": "IO", "semantics": "SELF", "pos": "PRON", "forms": ["IO"]},
                {"lemma": "GRAZIE", "semantics": "THANKS", "pos": "INTERJ", "forms": ["GRAZIE"]},
                {"lemma": "ADDIO", "semantics": "FAREWELL", "pos": "INTERJ", "forms": ["ADDIO"]},
                {"lemma": "OK_IT", "semantics": "CONFIRM", "pos": "ADV", "forms": ["OK", "CERTO"]},
                {"lemma": "CHE", "semantics": "QUESTION_FACT", "pos": "PRON", "forms": ["CHE"]},
                {"lemma": "FAI", "semantics": "COMMAND", "pos": "VERB", "forms": ["FAI", "CALCOLA", "ESEGUI"]},
          ],
          ...
          "syntactic_patterns": [
              ...
              {"name": "QUESTION_HEALTH_VERBOSE_IT", "sequence": ["QUESTION_HOW", "BE_STATE"]},
                {"name": "THANKS_IT", "sequence": ["THANKS"]},
                {"name": "FAREWELL_IT", "sequence": ["FAREWELL"]},
                {"name": "CONFIRM_IT", "sequence": ["CONFIRM"]},
                {"name": "QUESTION_FACT_IT", "sequence": ["QUESTION_FACT"]},
                {"name": "COMMAND_IT", "sequence": ["COMMAND"]},
          ],
          "idiom_equivalents": [
          ...
          "dialog_rules": [
              ...
              },
              {
                ...
                {
                    "trigger_role": "THANKS_IT",
                    "reply_role": "THANKS_IT_REPLY",
                    "reply_semantics": "THANKS_ACK",
                    "surface_tokens": ["di", "niente", "!"],
                    "language": "it",
                },
                {
                    "trigger_role": "FAREWELL_IT",
                    "reply_role": "FAREWELL_IT_REPLY",
                    "reply_semantics": "FAREWELL_ACK",
                    "surface_tokens": ["a", "presto", "."],
                    "language": "it",
                },
                {
                    "trigger_role": "CONFIRM_IT",
                    "reply_role": "CONFIRM_IT_REPLY",
                    "reply_semantics": "CONFIRM_ACK",
                    "surface_tokens": ["ok", ",", "procedo", "."],
                    "language": "it",
                },
                {
                    "trigger_role": "QUESTION_FACT_IT",
                    "reply_role": "FACT_ROUTE_IT",
                    "reply_semantics": "FACT_ROUTE",
                    "surface_tokens": ["controllo", "con", "il", "nucleo", "."],
                    "language": "it",
                },
                {
                    "trigger_role": "COMMAND_IT",
                    "reply_role": "COMMAND_IT_ACK",
                    "reply_semantics": "COMMAND_ACK",
                    "surface_tokens": ["ricevuto", ",", "procedendo", "."],
                    "language": "it",
                },
          ],
          "conjugations": [
              ...
              {"lemma": "stare", "tense": "pres", "person": 3, "number": "sing", "form": "sta"},
                {"lemma": "avere", "tense": "pres", "person": 1, "number": "sing", "form": "ho"},
                {"lemma": "avere", "tense": "pres", "person": 3, "number": "sing", "form": "ha"},
                {"lemma": "essere", "tense": "pres", "person": 1, "number": "sing", "form": "sono"},
                {"lemma": "essere", "tense": "pres", "person": 3, "number": "sing", "form": "è"},
          ],
    },
}

# Expand verbs with autogenerated datasets (verbos primeiro, léxicos base após)
LANGUAGE_PACK_DATA["pt"]["lexemes"] = PT_VERB_LEXEMES + LANGUAGE_PACK_DATA["pt"]["lexemes"]
LANGUAGE_PACK_DATA["pt"].setdefault("conjugations", []).extend(PT_CONJUGATIONS)
LANGUAGE_PACK_DATA["es"]["lexemes"] = ES_VERB_LEXEMES + LANGUAGE_PACK_DATA["es"]["lexemes"]
LANGUAGE_PACK_DATA["es"].setdefault("conjugations", []).extend(ES_CONJUGATIONS)
LANGUAGE_PACK_DATA["fr"]["lexemes"] = FR_VERB_LEXEMES + LANGUAGE_PACK_DATA["fr"]["lexemes"]
LANGUAGE_PACK_DATA["fr"].setdefault("conjugations", []).extend(FR_CONJUGATIONS)
LANGUAGE_PACK_DATA.setdefault("it", {}).setdefault("lexemes", [])
LANGUAGE_PACK_DATA["it"]["lexemes"] = IT_VERB_LEXEMES + LANGUAGE_PACK_DATA["it"]["lexemes"]
LANGUAGE_PACK_DATA["it"].setdefault("dialog_rules", [])
LANGUAGE_PACK_DATA["it"].setdefault("stopwords", [])
LANGUAGE_PACK_DATA["it"].setdefault("syntactic_patterns", [])
LANGUAGE_PACK_DATA["it"].setdefault("conjugations", []).extend(IT_CONJUGATIONS)
LANGUAGE_PACK_DATA["en"]["lexemes"] = EN_VERB_LEXEMES + LANGUAGE_PACK_DATA["en"]["lexemes"]
LANGUAGE_PACK_DATA["en"].setdefault("conjugations", []).extend(EN_CONJUGATIONS)

EXTERNAL_LANGUAGE_PACK_DATA = _load_external_packs()
VERB_METADATA = VERB_METADATA_MAP
